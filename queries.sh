...
echo "$($PSQL "SELECT DISTINCT name FROM teams INNER JOIN games ON teams.team_id = winner_id OR teams.team_id = opponent_id WHERE year = 2014 AND round = 'Eighth-Final' ORDER BY name")"
